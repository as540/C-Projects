...
int main(){
	...
	while(1){
		cout<<endl<<endl<<"\t\t___MENU____"<<endl<<"1.Entry of New Book"<<endl<<"2.Buy Book"<<endl<<"3.Search For Book"<<endl<<"4.Edit Details Of Book"<<endl<<"5.Exit"<<endl<<endl<<"Enter your Choice:";
		cin>>choice_number;
